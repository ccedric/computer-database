...
public class CommandLineInterface {
	...
	private void updateComputer() {
		...
		while (true) {
			try {
				System.out
						.println("Please enter the id of the manufacturer of the computer, type 0 if you don't want to"
		...
		while (true) {
			System.out.println("Please enter the introduced timestamp, format: yyyy-MM-dd, type 0 if you don't want to"
					+ " add this value, or type q to go back to the menu");
			String input = sc.nextLine();
			if (input.equals("q")) {
				showHelp();
		...
		while (true) {
			System.out.println("Please enter the discontinued timestamp, format: yyyy-MM-dd, type 0 if you don't want"
	...
	private void createComputer() {
		System.out.println(
				"Please enter the name of the computer you want to create," + " or type q to go back to the menu");
		String name = sc.nextLine();
		if (name.equals("q")) {
			showHelp();
		}
		...
		while (true) {
			try {
				System.out.println("Please enter the id of the manufacturer of the computer, type 0 if you don't want"
						+ " to add this value, or type q to go back to the menu");
				String input = sc.nextLine();
				if (input.equals("q")) {
					showHelp();
		...
		LocalDate timestamp = null;
		while (true) {
			System.out.println("Please enter the introduced timestamp, format: yyyy-MM-dd, type 0 if you don't want"
					+ " to add this value, or type q to go back to the menu");
			String input = sc.nextLine();
			if (input.equals("q")) {
				showHelp();
		...
		LocalDate timestampEnd = null;
		while (true) {
			System.out.println("Please enter the discontinued timestamp, format: yyyy-MM-dd, or type 0 if you don't"
	...
	private void listComputer() {
		...
		while (true) {
			...
			System.out.println();
			System.out.println("Type next if you want to see the next 10 computers, prev if you want to see the 10 "
